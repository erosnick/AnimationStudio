...
layout (location = 8) uniform mat4 animationPose[120];

void main()
{
    mat4 skin  = animationPose[joints.x] * weights.x;
               + animationPose[joints.y] * weights.y;
               + animationPose[joints.z] * weights.z;
               + animationPose[joints.w] * weights.w;
